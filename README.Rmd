---
title: "bipsdown: RMarkdown themes for BIPS"
---
...
You can find a demo presentation [here](https://bips-hb.github.io/bipsdown/bips-xaringan/bips-xaringan.html), and also here:

```{r, echo = FALSE}
xaringanExtra::embed_xaringan(
  url = "https://bips-hb.github.io/bipsdown/bips-xaringan/",
  ratio = "16:9"
)
```
